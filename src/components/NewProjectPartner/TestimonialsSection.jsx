...
export default function TestimonialsSection() {
  ...
  return (
    <section className="lg:py-20 bg-white w-full mt-10">
      ...
      {/* Testimonials Grid */}
      <div className="max-w-7xl mx-auto px-2 grid grid-cols-1 md:grid-cols-2 gap-10 lg:px-6 md:px-6 sm:px-6">
        {testimonials.map((item, index) => (
          <div
            key={index}
            className="bg-white border border-[#EAECF0] rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.05)] p-8 flex flex-col"
          >
            {/* Quote Icon */}
...
<path d="M5 3C4.46957 3 3.96086 3.21071 3.58579 3.58579C3.21071 3.96086 3 4.46957 3 5V11C3 11.5304 3.21071 12.0391 3.58579 12.4142C3.96086 12.7893 4.46957 13 5 13C5.26522 13 5.51957 13.1054 5.70711 13.2929C5.89464 13.4804 6 13.7348 6 14V15C6 15.5304 5.78929 16.0391 5.41421 16.4142C5.03914 16.7893 4.53043 17 4 17C3.73478 17 3.48043 17.1054 3.29289 17.2929C3.10536 17.4804 3 17.7348 3 18V20C3 20.2652 3.10536 20.5196 3.29289 20.7071C3.48043 20.8946 3.73478 21 4 21C5.5913 21 7.11742 20.3679 8.24264 19.2426C9.36786 18.1174 10 16.5913 10 15V5C10 4.46957 9.78929 3.96086 9.41421 3.58579C9.03914 3.21071 8.53043 3 8 3H5Z" stroke="#5E23DC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div className="flex items-center justify-between gap-1">
              ...
              <div className="flex items-center gap-0">
                ...
                />
                <div>
                  <h4 className="text-[#101828]  font-medium">{item.name}</h4>
                  <p className="text-[#667085] text-[11px] lg:text-sm md:text-sm sm:text-sm">{item.role}</p>
                </div>
              </div>

              {/* Projects box */}
              <div className="bg-[#5E23DC47] px-2 py-1 rounded-xl text-center">
      ...
      <div className="text-center mt-20 px-4">
        ...
        <button
          className="
            mt-6 bg-[#5E23DC] 
            text-white lg:text-lg md:text-lg sm:text-lg text-[15px] whitespace-nowrap font-medium
            px-10 py-4 rounded-xl shadow-[0px_10px_15px_-3px_rgba(94,35,220,0.28),0px_4px_6px_-4px_rgba(94,35,220,0.28)]
