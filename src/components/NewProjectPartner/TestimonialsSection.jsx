...
const TestimonialCard = ({ item }) => (
  <div className="bg-white border border-[#EAECF0] rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.05)] p-8 flex flex-col h-full">
    ...
    <div className="flex mt-4">
      {[...Array(5)].map((_, i) => (
        <svg key={i} width="20" height="20" fill="#FEC84B" viewBox="0 0 24 24">
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h4 className="font-medium text-[#101828]">{item.name}</h4>
          <p className="text-[#667085] text-sm">{item.role}</p>
        </div>
      </div>
