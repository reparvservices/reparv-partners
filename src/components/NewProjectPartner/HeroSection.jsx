...
const StatItem = memo(({ icon: Icon, title, subtitle }) => (
  <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-3">
    <Icon className="text-[#5E23DC]" size={14} />
    <div>
...
const HeroSection = () => {
  ...
  return (
    <section className="w-full relative overflow-hidden bg-gradient-to-br from-[#F4F0FF] via-white to-[#F7F5FF]">
      <div className="z-10 mt-0 sm:mt-20 w-full max-w-[1350px] mx-auto px-6 lg:px-20 py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        {/* ---------- LEFT CONTENT ---------- */}
        <div className="">
          {/* Badge */}
          ...
          {/* Heading */}
          <h1 className="mt-4 xl:mt-6 text-[42px] leading-tight lg:text-[42px] xl:text-[50px] font-extrabold text-[#2E1A6F]">
            Become a Project <br /> Partner Today
          </h1>

          {/* Description */}
          <p className="mt-4 xl:mt-5 max-w-xl text-base xl:text-lg text-[#5B5B6B]">
            Connect with premium projects, grow your business, and earn more
            with India’s most trusted partner network.
          </p>

          {/* Buttons */}
          <div className="mt-6 xl:mt-8 flex gap-2 sm:gap-4 items-center">
            <button
              onClick={scrollToPricing}
              className="w-full sm:w-auto bg-[#5E23DC] text-white text-[13px] sm:text-base font-semibold px-4 py-3 sm:px-8 rounded-lg shadow-[0_8px_20px_rgba(94,35,220,0.35)] hover:bg-[#4b1cc0] transition-all active:scale-95 flex items-center gap-2 justify-center"
            >
              JOIN AS PARTNER
              <svg
                viewBox="0 0 10 16"
            ...
            <button
              onClick={openVideo}
              className="group w-full sm:w-auto border border-[#5E23DC] text-[#5E23DC] text-[13px] sm:text-base font-semibold px-4 py-3 sm:px-8 rounded-lg flex items-center gap-2 justify-center hover:bg-[#5E23DC]/10 transition-all active:scale-95"
            >
