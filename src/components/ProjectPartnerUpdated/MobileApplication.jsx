...
const MobileAppSection = () => {
  return (
    <section className="relative mt-[-140px] bg-[#5E23DC] text-white py-16 px-4 md:px-12 lg:px-24 flex flex-col items-center">
      ...
      <p className="text-center text-sm md:text-base mb-12 max-w-2xl">
      ...
      <div className="relative flex flex-col md:flex-row items-center md:justify-center w-full space-y-12 md:space-y-0">
        ...
        <div className="flex flex-col lg:space-y-24 md:space-y-12 space-y-12 md:mr-8 md:text-left text-center">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-3 md:space-y-0 md:space-x-3">
            <div className="bg-white text-purple-700 p-3 rounded-lg">
              {/* SVG icon */}
        ...
        <div className="relative">
          ...
          {/* Growth Badge */}
          <div className="absolute -left-12 bottom-[220px] md:bottom-[250px] z-20 bg-white text-[#5E23DC] px-4 py-2 rounded-[16px] flex flex-col items-start shadow-lg">
        ...
        {/* Right Features */}
        <div className="flex flex-col lg:space-y-24 md:space-y-12 space-y-12 md:ml-8 md:text-left text-center">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-3 md:space-y-0 md:space-x-3">
            <div className="bg-white text-purple-700 p-3 rounded-lg">
              {/* SVG icon */}
      ...
      <div className="flex gap-6 mt-12 flex-wrap justify-center">
        <img src={ios} alt="App Store" className="h-12 cursor-pointer" />
        <a href="https://play.google.com/store/apps/details?id=com.reparvprojectpartner" target="_blank" rel="noopener noreferrer">
