...
const MobileAppSection = () => {
  return (
    <section className="relative lg:mt-[-140px] bg-[#5E23DC] text-white py-16 px-4 md:px-12 lg:px-24 flex flex-col items-center overflow-hidden">
      {/* Badge */}
       ...
       (
        ...
        <div className="relative flex justify-center">
          <img
            src={mobileAppImage}
            alt="Mobile App"
            className="w-[300px] sm:w-[260px] md:w-[350px] lg:w-[400px] z-10"
          />

          {/* Growth Badge */}
          <div className="absolute left-1 h-[50px] z-30 bottom-18 md:-left-12 md:bottom-[250px] bg-white text-[#5E23DC] px-3 py-2 rounded-xl shadow-lg">
          ...
          {/* Earned Badge */}
          <div className="absolute right-[-3px] bottom-[50px] md:-right-12 md:bottom-[120px] bg-white text-[#5E23DC] px-3 py-2 h-[50px] z-30 rounded-xl shadow-lg">
            <div className="flex items-center gap-2">
              <div className="w-9 h-9 bg-[#DBEAFE] rounded-full flex items-center justify-center">
